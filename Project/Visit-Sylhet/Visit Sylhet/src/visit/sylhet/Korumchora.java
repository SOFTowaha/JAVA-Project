 ...
 * @author Anik
 */
public class Korumchora extends javax.swing.JFrame {

    /**
     * Creates new form Korumchora
     */
    public Korumchora() {
        initComponents();
    }
...
>>>>>>> origin/master
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Korumchora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Korumchora().setVisible(true);
            }
        });
    }
