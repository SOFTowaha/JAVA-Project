 ...
 * @author Anik
 */
public class Pangthumai extends javax.swing.JFrame {

    /**
     * Creates new form Pangthumai
     */
    public Pangthumai() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pangthumai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pangthumai().setVisible(true);
            }
        });
    }
