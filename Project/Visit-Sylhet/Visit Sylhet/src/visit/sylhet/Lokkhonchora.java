 ...
 * @author Anik
 */
public class Lokkhonchora extends javax.swing.JFrame {

    /**
     * Creates new form Lokkhonchora
     */
    public Lokkhonchora() {
        initComponents();
    }
...
>>>>>>> origin/master
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lokkhonchora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lokkhonchora().setVisible(true);
            }
        });
    }
